...
export const CoachingOptions = [
    ...
    },
    {
        ...
        summeryPrompt: "Based on the conversation, provide feedback to the user along with suggestions for areas of improvement, presented in a well-structured format.",
        abstract: '/ab2.png'
