...
//             >
//                 <div className="absolute w-full h-full backface-hidden bg-yellow-600 p-6 rounded-lg shadow-lg overflow-auto">
//                     <div className="text-white">{frontContent}</div>
//                 </div>
//                 <div className="absolute w-full h-full backface-hidden bg-amber-700 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
...
// export default function JavaScriptHotel() {
...
//             }
//         });
//         loadJavaScriptHotelMusic("/sounds/healing.mp3").then(() => {
//             playJavaScriptHotelMusic();
//         });
//         return () => {
//             stopJavaScriptHotelMusic();
...
//         if (player.javaScriptMastered[topicName] >= 1) {
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `${javaScriptData[topicName].title} already mastered!` },
//             });
//             return;
//         }
...
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: `Started studying ${javaScriptData[topicName].title}!` },
//         });
//     };

//     const handleNextPage = () => {
//         if (currentPage < javaScriptData[selectedTopic].pages.length - 1) {
//             if (pageRef.current) {
...
//                     dispatch({
//                         type: "SET_MESSAGE",
//                         payload: { text: `Studied page ${currentPage + 2} of ${javaScriptData[selectedTopic].title}.` },
//                     });
//                 }, 500);
//             } else {
//                 setCurrentPage(currentPage + 1);
...
//         } else {
//             setShowQuiz(true);
//             setQuizAnswers(new Array(javaScriptData[selectedTopic].quiz.length).fill(null));
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `Completed study for ${javaScriptData[selectedTopic].title}. Time for the quiz!` },
//             });
//         }
//     };
...
//         let score = 0;
//         const quizQuestions = javaScriptData[selectedTopic].quiz;
...
//             payload: {
//                 text: isPerfectScore
//                     ? `Mastered ${javaScriptData[selectedTopic].title} with a perfect score! Earned $50!`
//                     : `Scored ${score}/${quizQuestions.length} on ${javaScriptData[selectedTopic].title} quiz. ${score > 0 ? `Earned $${cashReward} cash!` : "Lost $20."}`,
//             },
//         });
//     };

//     const exitJavaScriptHotel = () => {
//         dispatch({ type: "CHANGE_SCREEN", payload: { screen: "location" } });
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: "Left JavaScript Hotel." },
//         });
//     };

//     if (!selectedTopic) {
//         return (
//             <div className="min-h-screen mx-auto p-6 bg-gradient-to-b from-yellow-500 via-amber-900 to-black rounded-lg shadow-lg">
//                 <div className="text-center mb-6">
//                     <ProfessorHeader />
//                     <h2 className="text-3xl font-bold text-white">JavaScript Hotel</h2>
//                     <button
//                         onClick={exitJavaScriptHotel}
//                         className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-yellow-800 rounded-lg font-bold"
//                     >
//                         Exit JavaScript Hotel
//                     </button>
//                 </div>
//                 <p className="text-center mb-8 text-white">Select a JavaScript topic to study:</p>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//                     {Object.keys(javaScriptData).map((topic, index) => (
//                         <motion.div
//                             key={topic}
...
//                                 className={`w-full p-4 rounded-lg text-center transition text-white ${player.javaScriptMastered[topic] >= 1
//                                     ? "bg-gray-500 cursor-not-allowed"
//                                     : "bg-yellow-500 hover:bg-amber-900"
//                                     }`}
//                                 disabled={player.javaScriptMastered[topic] >= 1}
//                             >
//                                 <h3 className="text-xl font-bold mb-2">{javaScriptData[topic].title}</h3>
//                                 <p className="text-sm">{javaScriptData[topic].description}</p>
//                                 {player.javaScriptMastered[topic] >= 1 && (
//                                     <p className="text-xs text-yellow-300 mt-2">✓ Mastered</p>
//                                 )}
//                             </button>
//                         </motion.div>
//                     ))}
...
//     const topicContent = javaScriptData[selectedTopic];

//     if (showQuiz) {
//         return (
//             <div className="w-full min-h-screen p-6 bg-gradient-to-r from-yellow-600 via-amber-800 to-black rounded-lg shadow-lg">
//                 <ProfessorHeader />
...
//     return (
//         <div className="min-h-screen mx-auto p-6 bg-gradient-to-r from-yellow-500 via-amber-900 to-black rounded-lg shadow-lg">
//             <ProfessorHeader />
...
//                             <pre className="bg-gray-800 p-4 rounded-lg text-yellow-400 overflow-auto text-sm">
    ...
    return (
        ...
        >
            <motion.div
                ...
                transition={{ duration: 0.6 }}
            >
                <div className="absolute w-full h-full backface-hidden bg-yellow-600 bg-opacity-90 p-6 rounded-lg shadow-lg overflow-auto">
                    <div className="text-white">{frontContent}</div>
                </div>
                <div className="absolute w-full h-full backface-hidden bg-amber-700 bg-opacity-90 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
                    <div className="text-white">{backContent}</div>
                </div>
            </motion.div>
        </div>
            ...
            <div className="relative min-h-full bg-transparent mx-auto p-6 rounded-lg shadow-lg">
                ...
                <div className="content-container">
                    <div className="content-section text-center mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-white">JavaScript Hotel</h2>
                        <button
                            onClick={withSound(exitJavaScriptHotel)}
                            className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-yellow-800 rounded-lg font-bold"
                        >
                            Exit JavaScript Hotel
                        </button>
