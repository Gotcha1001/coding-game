...
//             >
//                 <div className="absolute w-full h-full backface-hidden bg-red-600 p-6 rounded-lg shadow-lg overflow-auto">
//                     <div className="text-white">{frontContent}</div>
//                 </div>
//                 <div className="absolute w-full h-full backface-hidden bg-red-700 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
...
// export default function GamingHotel() {
...
//             }
//         });
//         loadGamingHotelMusic("/sounds/healing.mp3").then(() => {
//             playGamingHotelMusic();
//         });
//         return () => {
//             stopGamingHotelMusic();
...
//         if (player.cppMastered[topicName] >= 1) {
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `${cppData[topicName].title} already mastered!` },
//             });
//             return;
//         }
...
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: `Started studying ${cppData[topicName].title}!` },
//         });
//     };

//     const handleNextPage = () => {
//         if (currentPage < cppData[selectedTopic].pages.length - 1) {
//             if (pageRef.current) {
...
//                     dispatch({
//                         type: "SET_MESSAGE",
//                         payload: { text: `Studied page ${currentPage + 2} of ${cppData[selectedTopic].title}.` },
//                     });
//                 }, 500);
//             } else {
//                 setCurrentPage(currentPage + 1);
...
//         } else {
//             setShowQuiz(true);
//             setQuizAnswers(new Array(cppData[selectedTopic].quiz.length).fill(null));
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `Completed study for ${cppData[selectedTopic].title}. Time for the quiz!` },
//             });
//         }
//     };
...
//         let score = 0;
//         const quizQuestions = cppData[selectedTopic].quiz;
...
//             payload: {
//                 text: isPerfectScore
//                     ? `Mastered ${cppData[selectedTopic].title} with a perfect score! Earned $50!`
//                     : `Scored ${score}/${quizQuestions.length} on ${cppData[selectedTopic].title} quiz. ${score > 0 ? `Earned $${cashReward} cash!` : "Lost $20."
//                     }`,
//             },
//         });
//     };

//     const exitGamingHotel = () => {
//         dispatch({ type: "CHANGE_SCREEN", payload: { screen: "location" } });
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: "Left Gaming Hotel." },
//         });
//     };

//     if (!selectedTopic) {
//         return (
//             <div className="min-h-screen mx-auto p-6 bg-gradient-to-b from-red-500 via-red-900 to-black rounded-lg shadow-lg">
//                 <div className="text-center mb-6">
//                     <ProfessorHeader />
//                     <h2 className="text-3xl font-bold text-white">Gaming Hotel</h2>
//                     <button
//                         onClick={withSound(exitGamingHotel)}
//                         className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-red-800 rounded-lg font-bold"
//                     >
//                         Exit Gaming Hotel
//                     </button>
//                 </div>
...
//                     {Object.keys(cppData).map((topic, index) => (
//                         <motion.div
//                             key={topic}
...
//                                 className={`w-full p-4 rounded-lg text-center transition text-white ${player.cppMastered[topic] >= 1
//                                         ? "bg-gray-500 cursor-not-allowed"
//                                         : "bg-red-500 hover:bg-red-900"
//                                     }`}
//                                 disabled={player.cppMastered[topic] >= 1}
//                             >
//                                 <h3 className="text-xl font-bold mb-2">{cppData[topic].title}</h3>
//                                 <p className="text-sm">{cppData[topic].description}</p>
//                                 {player.cppMastered[topic] >= 1 && (
//                                     <p className="text-xs text-red-300 mt-2">✓ Mastered</p>
//                                 )}
//                             </button>
//                         </motion.div>
//                     ))}
...
//     const topicContent = cppData[selectedTopic];

//     if (showQuiz) {
//         return (
//             <div className="w-full min-h-screen p-6 bg-gradient-to-r from-red-600 via-red-800 to-black rounded-lg shadow-lg">
//                 <ProfessorHeader />
...
//     return (
//         <div className="min-h-screen mx-auto p-6 bg-gradient-to-r from-red-500 via-red-900 to-black rounded-lg shadow-lg">
//             <ProfessorHeader />
...
//                             <pre className="bg-gray-800 p-4 rounded-lg text-red-400 overflow-auto text-sm">
//                                 {codeExamples}
//                             </pre>
//                         </div>
//                     }
...
const FlashCard = ({ frontContent, backContent, isFlipped, onClick }) => {
    return (
        ...
        >
            <motion.div
                className="w-full h-full relative preserve-3d transition amortize-all duration-500"
                animate={{ rotateY: isFlipped ? 180 : 0 }}
                transition={{ duration: 0.6 }}
            >
                <div className="absolute w-full h-full backface-hidden bg-red-600 bg-opacity-90 p-6 rounded-lg shadow-lg overflow-auto">
                    <div className="text-white">{frontContent}</div>
                </div>
                <div className="absolute w-full h-full backface-hidden bg-red-700 bg-opacity-90 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
                    <div className="text-white">{backContent}</div>
                </div>
            </motion.div>
        </div>
    ...
    if (!selectedTopic) {
        return (
            <div className="relative min-h-full bg-transparent mx-auto p-6 rounded-lg shadow-lg">
                ...
                >
                    <source src="https://cdn.pixabay.com/video/2023/08/31/178585-860270733_tiny.mp4" type="video/mp4" />
