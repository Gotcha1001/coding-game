...
//                 </div>
//                 <div className="absolute w-full h-full backface-hidden bg-green-800 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
...
// export default function ExpressHotel() {
...
//         if (player.expressMastered[topicName] >= 1) {
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `${expressData[topicName].title} already mastered!` },
//             });
//             return;
//         }
...
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: `Started studying ${expressData[topicName].title}!` },
//         });
//     };

//     const handleNextPage = () => {
//         if (currentPage < expressData[selectedTopic].pages.length - 1) {
//             if (pageRef.current) {
//                 pageRef.current.className.add("page-flip");
//                 setTimeout(() => {
//                     setCurrentPage(currentPage + 1);
//                     pageRef.current.className.remove("page-flip");
//                     dispatch({
//                         type: "SET_MESSAGE",
//                         payload: { text: `Studied page ${currentPage + 2} of ${expressData[selectedTopic].title}.` },
//                     });
//                 }, 500);
//             } else {
//                 setCurrentPage(currentPage + 1);
...
//         } else {
//             setShowQuiz(true);
//             setQuizAnswers(new Array(expressData[selectedTopic].quiz.length).fill(null));
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `Completed study for ${expressData[selectedTopic].title}. Time for the quiz!` },
//             });
//         }
//     };
...
//         if (currentPage > 0) {
//             if (pageRef.current) {
//                 pageRef.current.className.add("page-flip-reverse");
//                 setTimeout(() => {
//                     setCurrentPage(currentPage - 1);
//                     pageRef.current.className.remove("page-flip-reverse");
//                 }, 500);
//             } else {
//                 setCurrentPage(currentPage - 1);
//             }
...
//         let score = 0;
//         const quizQuestions = expressData[selectedTopic].quiz;
...
//             payload: {
//                 text: isPerfectScore
//                     ? `Mastered ${expressData[selectedTopic].title} with a perfect score! Earned $50!`
//                     : `Scored ${score}/${quizQuestions.length} on ${expressData[selectedTopic].title} quiz. ${score > 0 ? `Earned $${cashReward} cash!` : "Lost $20."}`,
//             },
//         });
//     };

//     const exitExpressHotel = () => {
//         // Wrap dispatch calls in a block to clarify intentional side effects
//         {
//             dispatch({ type: "CHANGE_SCREEN", payload: { screen: "location" } });
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: "Left Express Hotel." },
//             });
//         }
//     };
...
//     if (!selectedTopic) {
//         return (
//             <div className="min-h-screen mx-auto p-6 bg-gradient-to-b from-green-500 via-green-900 to-black rounded-lg shadow-lg">
//                 <div className="text-center mb-6">
//                     <ProfessorHeader />
//                     <h2 className="text-3xl font-bold text-white">Express Hotel</h2>
//                     <button
//                         onClick={exitExpressHotel}
//                         className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-green-800 rounded-lg font-bold"
//                     >
//                         Exit Express Hotel
//                     </button>
//                 </div>
//                 <p className="text-center mb-8 text-white">Select an Express.js topic to study:</p>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//                     {Object.keys(expressData).map((topic, index) => (
//                         <motion.div
//                             key={topic}
...
//                                 className={`w-full p-4 rounded-lg text-center transition text-white ${player.expressMastered[topic] >= 1
//                                         ? 'bg-gray-500 cursor-not-allowed'
//                                         : 'bg-green-500 hover:bg-green-900'
//                                     }`}
//                                 disabled={player.expressMastered[topic] >= 1}
//                             >
//                                 <h3 className="text-xl font-bold mb-2">{expressData[topic].title}</h3>
//                                 <p className="text-sm">{expressData[topic].description}</p>
//                                 {player.expressMastered[topic] >= 1 && (
...
//     const topicContent = expressData[selectedTopic];

//     if (showQuiz) {
//         return (
//             <div className="w-full min-h-screen p-6 bg-gradient-to-r from-green-600 via-green-800 to-black rounded-lg shadow-lg">
//                 <ProfessorHeader />
...
//                                 <motion.div
//                                     key={qIndex}
//                                     className="p-俩bg-white rounded-lg text-black"
...
//     return (
//         <div className="min-h-screen mx-auto p-6 bg-gradient-to-r from-green-500 via-green-900 to-black rounded-lg shadow-lg">
//             <ProfessorHeader />
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute w-full h-full backface-hidden bg-green-800 bg-opacity-90 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
                    <div className="text-white">{backContent}</div>
                </div>
            </motion.div>
        </div>
    ...
    if (!selectedTopic) {
        return (
            <div className="relative min-h-full bg-transparent mx-auto p-6 rounded-lg shadow-lg">
                ...
                >
                    <source src="https://cdn.pixabay.com/video/2018/05/30/16500-273202599_tiny.mp4" type="video/mp4" />
                ...
                <div className="content-container">
                    <div className="content-section text-center mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-white">Express Hotel</h2>
                        <button
                            onClick={withSound(exitExpressHotel)}
                            className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-green-800 rounded-lg font-bold"
                        >
                            Exit Express Hotel
                        </button>
