...
//     initAudio,
//     loadClickSound,
//     loadReactNativeMusic, // New function for React Native music
//     playReactNativeMusic, // New function for React Native music
//     stopReactNativeMusic, // New function for React Native music
...
// export default function ReactNativeUniversity() {
...
//             }
//         });
//         loadReactNativeMusic("/sounds/healing.mp3").then(() => {
//             playReactNativeMusic();
//         });
//         return () => {
...
//         if (player.reactNativeMastered[topicName] >= 1) {
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `${reactNativeData[topicName].title} already mastered!` },
//             });
//             return;
//         }
...
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: `Started studying ${reactNativeData[topicName].title}!` },
//         });
//     };

//     const handleNextPage = () => {
//         if (currentPage < reactNativeData[selectedTopic].pages.length - 1) {
//             if (pageRef.current) {
...
//                     dispatch({
//                         type: "SET_MESSAGE",
//                         payload: { text: `Studied page ${currentPage + 2} of ${reactNativeData[selectedTopic].title}.` },
//                     });
//                 }, 500);
//             } else {
//                 setCurrentPage(currentPage + 1);
...
//         } else {
//             setShowQuiz(true);
//             setQuizAnswers(new Array(reactNativeData[selectedTopic].quiz.length).fill(null));
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `Completed study for ${reactNativeData[selectedTopic].title}. Time for the quiz!` },
//             });
//         }
//     };
...
//         let score = 0;
//         const quizQuestions = reactNativeData[selectedTopic].quiz;
...
//             payload: {
//                 text: isPerfectScore
//                     ? `Mastered ${reactNativeData[selectedTopic].title} with a perfect score! Earned $50!`
//                     : `Scored ${score}/${quizQuestions.length} on ${reactNativeData[selectedTopic].title} quiz. ${score > 0 ? `Earned $${cashReward} cash!` : "Lost $20."}`,
//             },
//         });
//     };

//     const exitReactNativeUniversity = () => {
//         dispatch({ type: "CHANGE_SCREEN", payload: { screen: "location" } });
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: "Left React Native University." },
//         });
//     };
...
//                     <ProfessorHeader />
//                     <h2 className="text-3xl font-bold text-white">React Native University</h2>
//                     <button
//                         onClick={exitReactNativeUniversity}
//                         className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-blue-800 rounded-lg font-bold"
//                     >
//                         Exit React Native University
//                     </button>
//                 </div>
//                 <p className="text-center mb-8 text-white">Select a React Native topic to study:</p>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//                     {Object.keys(reactNativeData).map((topic, index) => (
//                         <motion.div
//                             key={topic}
...
//                                 className={`w-full p-4 rounded-lg text-center transition text-white ${player.reactNativeMastered[topic] >= 1
//                                     ? "bg-gray-500 cursor-not-allowed"
//                                     : "bg-blue-500 hover:bg-blue-900"
//                                     }`}
//                                 disabled={player.reactNativeMastered[topic] >= 1}
//                             >
//                                 <h3 className="text-xl font-bold mb-2">{reactNativeData[topic].title}</h3>
//                                 <p className="text-sm">{reactNativeData[topic].description}</p>
//                                 {player.reactNativeMastered[topic] >= 1 && (
...
//     const topicContent = reactNativeData[selectedTopic];
...
export default function ReactNativeUniversity() {
    ...
    useEffect(() => {
        ...
        loadReactNativeMusic("/sounds/reactn.mp3").then(() => {
            playReactNativeMusic();
        });
        return () => {
            stopReactNativeMusic();
