...
//                 </div>
//                 <div className="absolute w-full h-full backface-hidden bg-indigo-700 p-6 rounded-lg shadow-lg rotate-y-180 overflow-auto">
...
// export default function JavaResort() {
...
//             }
//         });
//         loadJavaResortMusic("/sounds/healing.mp3").then(() => {
//             playJavaResortMusic();
//         });
//         return () => {
//             stopJavaResortMusic();
...
//         if (player.javaMastered[topicName] >= 1) {
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `${javaData[topicName].title} already mastered!` },
//             });
//             return;
//         }
...
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: `Started studying ${javaData[topicName].title}!` },
//         });
//     };

//     const handleNextPage = () => {
//         if (currentPage < javaData[selectedTopic].pages.length - 1) {
//             if (pageRef.current) {
...
//                     dispatch({
//                         type: "SET_MESSAGE",
//                         payload: { text: `Studied page ${currentPage + 2} of ${javaData[selectedTopic].title}.` },
//                     });
//                 }, 500);
//             } else {
//                 setCurrentPage(currentPage + 1);
...
//         } else {
//             setShowQuiz(true);
//             setQuizAnswers(new Array(javaData[selectedTopic].quiz.length).fill(null));
//             dispatch({
//                 type: "SET_MESSAGE",
//                 payload: { text: `Completed study for ${javaData[selectedTopic].title}. Time for the quiz!` },
//             });
//         }
//     };
...
//         let score = 0;
//         const quizQuestions = javaData[selectedTopic].quiz;
...
//             payload: {
//                 text: isPerfectScore
//                     ? `Mastered ${javaData[selectedTopic].title} with a perfect score! Earned $50!`
//                     : `Scored ${score}/${quizQuestions.length} on ${javaData[selectedTopic].title} quiz. ${score > 0 ? `Earned $${cashReward} cash!` : "Lost $20."}`,
//             },
//         });
//     };

//     const exitJavaResort = () => {
//         dispatch({ type: "CHANGE_SCREEN", payload: { screen: "location" } });
//         dispatch({
//             type: "SET_MESSAGE",
//             payload: { text: "Left Java Resort." },
//         });
//     };

//     if (!selectedTopic) {
//         return (
//             <div className="min-h-screen mx-auto p-6 bg-gradient-to-b from-blue-500 via-indigo-900 to-black rounded-lg shadow-lg">
//                 <div className="text-center mb-6">
//                     <ProfessorHeader />
//                     <h2 className="text-3xl font-bold text-white">Java Resort</h2>
//                     <button
//                         onClick={exitJavaResort}
//                         className="mt-4 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-blue-800 rounded-lg font-bold"
//                     >
//                         Exit Java Resort
//                     </button>
//                 </div>
//                 <p className="text-center mb-8 text-white">Select a Java topic to study:</p>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//                     {Object.keys(javaData).map((topic, index) => (
//                         <motion.div
//                             key={topic}
...
//                                 className={`w-full p-4 rounded-lg text-center transition text-white ${player.javaMastered[topic] >= 1
//                                     ? "bg-gray-500 cursor-not-allowed"
//                                     : "bg-blue-500 hover:bg-indigo-900"
//                                     }`}
//                                 disabled={player.javaMastered[topic] >= 1}
//                             >
//                                 <h3 className="text-xl font-bold mb-2">{javaData[topic].title}</h3>
//                                 <p className="text-sm">{javaData[topic].description}</p>
//                                 {player.javaMastered[topic] >= 1 && (
...
//     const topicContent = javaData[selectedTopic];

//     if (showQuiz) {
//         return (
//             <div className="w-full min-h-screen p-6 bg-gradient-to-r from-blue-600 via-indigo-800 to-black rounded-lg shadow-lg">
//                 <ProfessorHeader />
...
//     return (
//         <div className="min-h-screen mx-auto p-6 bg-gradient-to-r from-blue-500 via-indigo-900 to-black rounded-lg shadow-lg">
//             <ProfessorHeader />
...
export default function JavaResort() {
    ...
    useEffect(() => {
        ...
        loadJavaResortMusic("/sounds/java.mp3").then(() => {
            playJavaResortMusic();
        });
        return () => {
            stopJavaResortMusic();
